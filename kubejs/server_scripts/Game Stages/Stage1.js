...
event.shapeless('minecraft:torch','2x minecraft:stick')
    //删除平底锅 大锅
...
event.recipes.exnihilosequentia.sieve('minecraft:dirt','minecraft:wheat_seeds')
    .addRoll(0.60,'string')
    .addRoll(0.45,'flint')
event.recipes.exnihilosequentia.sieve('minecraft:dirt','minecraft:rotten_flesh')
    .addRoll(0.50,'string')
    .addRoll(0.45,'flint')
...
event.recipes.createCompacting('minecraft:egg',['minecraft:wheat','8x minecraft:cobblestone'])
...
event.shaped('minecraft:egg',[
    ...
    F:'minecraft:apple',
    G:'farmersdelight:rice_panicle',
    H:'minecraft:carrot',
    I:'farmersdelight:cabbage'
})
})
